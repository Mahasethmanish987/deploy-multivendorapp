...
urlpatterns = [
    ...
    path(
        "server-update-order-status",
        views.server_update_order_status,
        name="server_update_order_status",
    ),
    ...
    path(
        "vendor_orders/<str:order_number>/",
    ...
    path(
        "payouts_detail/<int:pk>/",
        views.vendor_payout_detail,
        name="vendor_payout_detail",
    ),
    path(
        "fake-esewa-success/",
        views.fake_handle_esewa,
        name="fake_handle_esewa",
    ),
]
